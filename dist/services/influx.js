...
const flushWrites = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const queryEquipmentMetrics = (equipmentId_1, type_1, ...args_1) => __awaiter(void 0, [equipmentId_1, type_1, ...args_1], void 0, function* (equipmentId, type, range = '1h') {
    const fluxQuery = `
  ...
  `;
    try {
        const rows = yield queryApi.collectRows(fluxQuery);
